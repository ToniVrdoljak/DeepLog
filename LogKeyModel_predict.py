...
if __name__ == '__main__':
    ...
    # Hyperparameters
    num_classes = 31
    model_path = "model/Adam_batch_size=8192_epochs=310_iteration=300.pt"
    ...
    test_normal_loader = generate('/home/toni/Downloads/balanced/normal_test.txt')
    test_abnormal_loader = generate('/home/toni/Downloads/balanced/anomaly.txt')
    TP = 0
    FP = 0
    # Test the model
